...
// CSS
import '../../css/documents/DTBPP.css'
...
const DTBPP = () => {
    ...
    useEffect(() => {
        ...
        document.title = "Drop Thee Ball: Privacy Policy";
    })
    ...
    <>
        ...
        <li>
        <p><strong>Application</strong> refers to Drop Thee Ball, the software program provided by the Company.</p>
        </li>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Drop Thee Ball.</p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: contact@peterbrumbach.com</li>
        </ul>
