...
async function footerMain() {
    ...
    document.getElementById("Terms").addEventListener("click", ()=>{redirect("/TOS")});
    document.getElementById("Sitemap").addEventListener("click", ()=>{redirect("/sitemap")});
    document.getElementById("Mystery").addEventListener("click", ()=>{redirect("/GetWrecked")});
...
async function getVerse() {
    ...
    bibleVerse.innerText = verses[randomNum].text + " - " + verses[randomNum].reference;
}
